...
,	CreatedById Int Constraint FK_FlightPlan_CoreUser_CreatedByUserId FOREIGN KEY References Core.Users(UserId)
,	ModifiedLast DateTime
,	ModifiedById Int Constraint FK_FlightPlan_CoreUser_ModifiedByUserId FOREIGN KEY References Core.Users(UserId)
)
